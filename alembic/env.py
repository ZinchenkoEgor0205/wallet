...
from src.common_deposit.models import Base as CommonDepositBase
from src.crypto_deposit.models import Base as CryptoDepositBase
target_metadata = [UserBase.metadata, CommonDepositBase.metadata, CryptoDepositBase.metadata]
